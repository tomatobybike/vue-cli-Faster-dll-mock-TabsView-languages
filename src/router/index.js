...
/*  {
  ...
  }, */
  {
    ...
    name: 'regulation',
    meta: {title: 'kicker', icon: 'rule'},
    children: [
      {
        path: 'kickerteam',
        name: 'Kickerteam',
        component: resolve => require(['@/views/kickerteam/index'], resolve),
        meta: {title: 'kickerteam', icon: 'kickerteam', roles: ['admin', 'editor']}
      }
       /*
      {
        path: 'hotspots',
